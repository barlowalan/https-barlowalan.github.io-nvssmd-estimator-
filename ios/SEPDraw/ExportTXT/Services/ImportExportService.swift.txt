...
extension UTType {
    ...
    static let sepdraw = UTType(exportedAs: "com.nvssmd.sepdraw.project", conformingTo: .json)
}
...
enum DesignExportService {
    enum ExportFormat: String, CaseIterable, Identifiable {
        ...
        var fileExtension: String {
            ...
            case .sepJSON: return "sepdraw.json"
            }
        }
    }
    ...
    static func exportPDF(project: DesignProject, sheet: DesignSheet) -> Data {
        ...
        return renderer.pdfData { ctx in
            ...
            ("SEP Draw · NVSSMD" as NSString).draw(at: CGPoint(x: 528, y: 528), withAttributes: [
    ...
    static func exportVisioXML(project: DesignProject, sheet: DesignSheet) -> String {
        ...
        <VisioDocument xmlns="http://schemas.microsoft.com/office/visio/2012/main">
          <DocumentProperties>
            ...
            <Creator>SEP Draw · NVSSMD</Creator>
